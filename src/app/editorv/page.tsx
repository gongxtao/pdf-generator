    ...
    <div className="min-h-screen w-full bg-gray-50 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col xl:flex-row min-w-0 overflow-hidden">
          {/* 左侧内容输入区域 */}
          <div className="w-full xl:w-1/3 bg-white border-r-0 xl:border-r border-gray-200 border-b xl:border-b-0 p-3 xl:p-4 flex flex-col min-h-[50vh] xl:min-h-0">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-gray-900">内容输入</h3>
            </div>
            ...
            {/* 文本输入区域 */}
             <div className="mb-6 flex-1 flex flex-col">
               ...
               <textarea
                 ...
                 className="w-full p-3 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent flex-1"
                 onDrop={(e) => {
                   e.preventDefault()
                   const files = Array.from(e.dataTransfer.files)
                   handleFileDrop(files)
              ...
              <div className="flex-1 bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="h-full flex flex-col">
                  ...
                  <div className="flex-1 p-4 flex flex-col">
                    <div className="flex-1 tiptap-editor-container border border-gray-300 rounded-lg overflow-hidden">
